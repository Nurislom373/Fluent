 ...
 */
public class DefaultTelegramBotApiFactory implements TelegramBotApiFactory {

    private final Class<? extends BotSession> botSessionClass;

    public DefaultTelegramBotApiFactory(Class<? extends BotSession> botSessionClass) {
    ...
    private TelegramBotsApi internalCreate() throws TelegramApiException {
        return new TelegramBotsApi(botSessionClass);
    }
}
