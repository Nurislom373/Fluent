 ...
 * @since 12/25/2023 12:03 AM
 */
@Service
public class VideoNoteMessageAppropriateMethod extends AbstractMessageAppropriateMethod {

    @Override
    public boolean isMatch(Message message) {
        return tryIsMatch(message::hasVideoNote);
    }
