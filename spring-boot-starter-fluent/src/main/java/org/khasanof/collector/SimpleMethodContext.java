...
/**
 * The {@link SimpleMethodContext} class collects the methods from the classes corresponding
...
@Slf4j
@Getter
@Component(SimpleMethodContext.NAME)
public class SimpleMethodContext implements ISimpleMethodContext {
    ...
    public SimpleMethodContext(BeansLoader resourceLoader, MethodCheckerAdapter checkerAdapter, ApplicationEventPublisher eventPublisher) {
